"""Suppl Fig S2 - ammonia-handling and nitrogen-assimilation modules, genus-aggregated.

Source: SUBMISSION/Supplementary_tables/Table_S2b_trait_module_per1kCDS.csv
        (per-MAG hits per 10^3 CDS; the Ammonia_N:: subcategory block: urea transport,
        GS-GOGAT, GDH, ammonium transport, PII regulators, nitrate/nitrite reduction).
