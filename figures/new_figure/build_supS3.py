"""Suppl Fig S3 - alkaline and osmotic-stress tolerance modules, genus-aggregated.

Source: SUBMISSION/Supplementary_tables/Table_S2b_trait_module_per1kCDS.csv
        (per-MAG hits per 10^3 CDS; the Alkaline_Osmo:: subcategory block - the header name
        of the category the legend calls "alkaline / osmotic stress").
